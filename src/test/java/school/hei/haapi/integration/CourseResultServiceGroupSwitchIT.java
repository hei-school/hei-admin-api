...
/**
 * Regression coverage for a student repeating a level: the same group ("J") is visited twice
 * (before and after a stint in another group "J2"), and each stint must resolve to its own level
 * instead of the whole history collapsing onto the most recently joined group. See
