...
public class TranscriptClaimIT {
  ...
  void student_read_ok() throws ApiException {
    ...
    StudentTranscriptClaim actualTranscript =
        api.getStudentClaimOfTranscriptVersion(
            STUDENT1_ID,
            TRANSCRIPT1_ID,
            STUDENT_TRANSCRIPT_VERSION1_ID,
            STUDENT_TRANSCRIPT_VERSION_CLAIM1_ID);
    List<StudentTranscriptClaim> actual =
        api.getStudentTranscriptClaims(
            STUDENT1_ID, TRANSCRIPT1_ID, STUDENT_TRANSCRIPT_VERSION1_ID, 1, 10);
  ...
  void manager_write_ok() throws ApiException {
    ...
    StudentTranscriptClaim actual =
        api.putStudentClaimsOfTranscriptVersion(
            STUDENT1_ID,
            TRANSCRIPT1_ID,
            STUDENT_TRANSCRIPT_VERSION1_ID,
            STUDENT_TRANSCRIPT_VERSION_CLAIM1_ID,
            studentTranscriptClaim1());
    List<StudentTranscriptClaim> expected =
        api.getStudentTranscriptClaims(
            STUDENT1_ID, TRANSCRIPT1_ID, STUDENT_TRANSCRIPT_VERSION1_ID, 1, 10);
  ...
  void student_read_ko() {
    ...
    assertThrowsApiException(
        "{\"type\":\"404 NOT_FOUND\",\"message\":\"Transcript claim id "
            + STUDENT_TRANSCRIPT_VERSION_CLAIM3_ID
            + " not found\"}",
        () ->
            api.getStudentClaimOfTranscriptVersion(
                STUDENT1_ID,
  ...
  //
  //        List<StudentTranscriptClaim> actual =
  // api.getStudentClaimOfTranscriptVersion(STUDENT2_ID, TRANSCRIPT1_ID,
  // STUDENT_TRANSCRIPT_VERSION1_ID , STUDENT_TRANSCRIPT_VERSION_CLAIM1_ID);
  //        StudentTranscriptVersion studentTranscriptVersion =
  // api.getStudentTranscriptByVersion(STUDENT1_ID,TRANSCRIPT1_ID,STUDENT_TRANSCRIPT_VERSION1_ID);
  //
