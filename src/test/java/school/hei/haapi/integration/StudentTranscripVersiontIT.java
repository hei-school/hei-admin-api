...
@Testcontainers
@ContextConfiguration(initializers = StudentTranscripVersiontIT.ContextInitializer.class)
@AutoConfigureMockMvc
@Slf4j
class StudentTranscripVersiontIT {
  @MockBean
  ...
  private static ApiClient anApiClient(String token) {
    return TestUtils.anApiClient(token, StudentTranscripVersiontIT.ContextInitializer.SERVER_PORT);
  }
