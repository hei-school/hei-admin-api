...
public class DelayPenaltyChangeIT {
  ...
  public static DelayPenalty delayPenalty1() {
    ...
    delayPenalty.setApplicabilityDelayAfterGrace(
        updateDelayPenalty().getApplicabilityDelayAfterGrace());
    return delayPenalty;
  }
  ...
  @Test
  void change_grace_delay_automatic_change_fees() throws ApiException {
    ...
    actualCreateDelayPenalty.setInterestTimerate(
    ...
    actualCreateDelayPenalty.setApplicabilityDelayAfterGrace(
        ActualDelayPenalty.getApplicabilityDelayAfterGrace());
    ...
    newCreateDelayPenalty.setApplicabilityDelayAfterGrace(
        ActualDelayPenalty.getApplicabilityDelayAfterGrace());
    ...
    Fee Fee7WithoutInterest =
        noUpdateFees.stream().filter(fee -> fee.getId().equals(fee7().getId()))
            .collect(Collectors.toList()).get(0);
    Fee originalFee7WithInterest =
        actualFeesWithInterest.stream().filter(fee -> fee.getId().equals(fee7().getId()))
            .collect(Collectors.toList()).get(0);
    Fee updatedFee7 =
        updatedFeesWithInterest.stream().filter(fee -> fee.getId().equals(fee7().getId()))
            .collect(Collectors.toList()).get(0);
    ...
    Fee Fee9WithoutInterest =
        noUpdateFees.stream().filter(fee -> fee.getId().equals(fee9().getId()))
            .collect(Collectors.toList()).get(0);
    Fee originalFee9WithInterest =
        actualFeesWithInterest.stream().filter(fee -> fee.getId().equals(fee9().getId()))
            .collect(Collectors.toList()).get(0);
    Fee updatedFee9 =
    ...
    Fee Fee3WithoutInterest =
        noUpdateFees.stream().filter(fee -> fee.getId().equals(fee3().getId()))
            .collect(Collectors.toList()).get(0);
    Fee originalFee3WithInterest =
        actualFeesWithInterest.stream().filter(fee -> fee.getId().equals(fee3().getId()))
            .collect(Collectors.toList()).get(0);
    Fee updatedFee3 =
        updatedFeesWithInterest.stream().filter(fee -> fee.getId().equals(fee3().getId()))
            .collect(Collectors.toList()).get(0);
  ...
  @Test
  void change_applicability_delay_after_grace_automatic_change_fees() throws ApiException {
    ApiClient manager1Client = anApiClient(MANAGER1_TOKEN);
    PayingApi api = new PayingApi(manager1Client);
    ...
    newCreateDelayPenalty.setApplicabilityDelayAfterGrace(
        ActualDelayPenalty.getApplicabilityDelayAfterGrace() - 5);
    api.createDelayPenaltyChange(newCreateDelayPenalty);
  ...
  @Test
  void change_interest_rate_automatic_change_fees() throws ApiException {
    ...
    Fee InitialFee7 =
        noUpdateFees.stream().filter(e -> e.getId().equals("fee7_id")).collect(Collectors.toList())
            .get(0);
    Fee ActualFee7 = actualFeesWithInterest.stream().filter(e -> e.getId().equals("fee7_id"))
        .collect(Collectors.toList()).get(0);
    ...
    int expectedRemainingAmount =
        InterestFormulaDaily(InitialFee7.getRemainingAmount(), ApplyDays1, InterestRate1);
    //From 13-03-23 to 15-03-23 : interestRate = 4; timeRate = DAILY
    int ApplyDays2 = 7;
    int InterestRate2 = 4;
    expectedRemainingAmount =
        InterestFormulaDaily(expectedRemainingAmount, ApplyDays2, InterestRate2);
