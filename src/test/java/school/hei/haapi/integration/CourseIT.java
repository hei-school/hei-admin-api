...
public class CourseIT {
    ...
    void read_course_ok() throws ApiException {
        ...
        List<Course> allCourses =
            api.getCourses(null, null, null, null, null, null, null, null, null);
        ...
        List<Course> coursesFilteredByCredits = api.getCourses(null, null, 6, null, null, null,
            null, null, null);
        List<Course> coursesFilteredByTeacherFirstName =
            api.getCourses(null, null, null, "Two", null,
                null, null, null, null);
        ...
        List<Course> coursesOrderByCode =
            api.getCourses(null, null, null, null, null, null, Order.DESC,
                null, null);
        ...
        assertTrue(
            firstCourseOrderByCredits.getCredits() < secondCourseOrderByCredits.getCredits());
        assertEquals(3, coursesOrderByCode.size());
        assertTrue(
            firstCourseOrderByCode.getCode().compareTo(secondCourseOrderByCode.getCode()) >= 0);
