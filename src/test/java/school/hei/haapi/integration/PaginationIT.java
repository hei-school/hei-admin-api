...
class PaginationIT {
  ...
  void student_pages_are_ordered_by_reference() throws ApiException {
    ...
    final List<Student> page1 = api.getStudents(1, pageSize, null, null, null, null, null, null);
    final List<Student> page2 = api.getStudents(2, pageSize, null, null, null, null, null, null);
    final List<Student> page3 = api.getStudents(3, pageSize, null, null, null, null, null, null);
    final List<Student> page4 = api.getStudents(4, pageSize, null, null, null, null, null, null);
    final List<Student> page100 = api.getStudents(100, pageSize, null, null, null, null, null, null);
  ...
  void page_parameters_are_validated() {
    ...
    assertThrowsApiException(
        ...
        () -> api.getStudents(0, 20, null, null, null, null, null, null));
    assertThrowsApiException(
        "{\"type\":\"400 BAD_REQUEST\",\"message\":\"page size must be <500\"}",
        () -> api.getStudents(1, 1000, null, null, null, null, null, null));
  }
