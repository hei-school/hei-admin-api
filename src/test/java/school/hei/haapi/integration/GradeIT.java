...
class GradeIT {
    ...
    void teacher_read_ok() throws ApiException {
        ...
        assertTrue(actual.containsAll(List.of(awardedCourseExam1(), awardedCourseExam2(), awardedCourseExam3(), awardedCourseExam4())));
    ...
    void student_read_his_grade_ok() throws ApiException {
        ...
        assertEquals(4, actual.size());
        assertTrue(actual.containsAll(List.of(awardedCourseExam1(), awardedCourseExam2(), awardedCourseExam3(),
                awardedCourseExam4())));
    ...
    void manager_create_grades_ok() throws ApiException {
        ApiClient manager1Client = anApiClient(MANAGER1_TOKEN);
        TeachingApi api = new TeachingApi(manager1Client);
        List<ExamDetail> actual = api.createStudentExamGrade(GROUP1_ID, AWARDED_COURSE1_ID, EXAM1_ID,
