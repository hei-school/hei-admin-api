...
class FeeIT {
    ...
    @Test
    void scheduler_apply_delay_penalty_on_a_fee_at_8am() throws ApiException {
        String instantExpected = "2023-04-03T08:00:0Z";
        Clock clock = Clock.fixed(Instant.parse(instantExpected), ZoneId.of("UTC+3"));
        ...
        Fee studentFeeById = payingApi.getStudentFeeById(STUDENT1_ID, FEE6_ID);
        Integer totalAmount = studentFeeById.getTotalAmount();
        Fee studentFeeByIdWithDelayPenalty = payingApi.getStudentFeeById(STUDENT1_ID, FEE6_ID);
        Integer totalAmountWithDelayPenalty = studentFeeByIdWithDelayPenalty.getTotalAmount();
        assertTrue(totalAmount < totalAmountWithDelayPenalty);
    }
