...
class RemedialServiceTest extends FacadeITMockedThirdParties {
  @MockBean private RemedialDao remedialDaoMock;
  @Autowired private RemedialService subject;
  ...
  void get_all_remedials_OK() {
    ...
    List<Remedial> remedials =
        subject.getAllRemedials(
            new PageFromOne(1), new BoundedPageSize(2), null, null, null, null, null, null);
