insert into "event"(id, type, title, description, color_code, "begin_datetime", "end_datetime", planner_id, course_id, room, place)
values('event1_id', 'COURSE','PROG1', 'Prog1 course', '#0000','2022-12-20T08:00:00.00Z', '2022-12-20T10:00:00.00Z', 'manager1_id', 'course1_id', 'UNKNOWN', 'ANDRAHARO'),
      ('event2_id', 'INTEGRATION','Integration Day', 'HEI students integration day','#0000', '2022-12-08T08:00:00.00Z', '2022-12-08T12:00:00.00Z', 'manager1_id', null, 'B', 'IVANDRY'),
      ('event3_id', 'SEMINAR','December Seminar', 'Seminar about Python programming language','#0000', '2022-12-09T08:00:00.00Z', '2022-12-09T12:00:00.00Z', 'manager10_id', null, null, null);
