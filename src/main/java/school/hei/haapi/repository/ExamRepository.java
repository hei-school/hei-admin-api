...
public interface ExamRepository extends JpaRepository<Exam, String> {
  ...
  Optional<Exam> findByIdAndAwardedCourseId(
      @Param("exam_id") String exam_id, @Param("awardedCourseId") String awardedCourseId);

  @Query("select e from Exam e where e.awardedCourse.id = :awarded_course_id")
  Page<Exam> findExamsByAwardedGroupId(
      @Param("awarded_course_id") String awardedCourseId, Pageable pageable);
}
