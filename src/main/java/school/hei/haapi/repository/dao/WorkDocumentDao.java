...
public class WorkDocumentDao {
  ...
  public List<WorkDocument> findAllByStudentIdAndProfessionalExperienceType(
      String studentId,
    ...
    if (professionalExperience != null) {
      Expression<ProfessionalExperienceFileTypeEnum> professionalExpExpression =
          root.get("professionalExperienceType");
