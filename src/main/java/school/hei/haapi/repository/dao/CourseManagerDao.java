...
if (credits==null){
    query
            .where(builder.and(hasCourseCode,hasCourseName,builder.or(hasTeacherFirstName,hasTeacherLastName)))
            .orderBy(QueryUtils.toOrders(pageable.getSort(), root, builder));
}else {
    query
            .where(builder.and(hasCourseCode,hasCourseName,builder.or(hasTeacherFirstName,hasTeacherLastName,hasCourseCredits)))
            .orderBy(QueryUtils.toOrders(pageable.getSort(), root, builder));
}
