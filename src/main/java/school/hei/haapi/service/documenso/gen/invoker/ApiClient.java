...
import school.hei.haapi.service.documenso.gen.invoker.auth.ApiKeyAuth;
import school.hei.haapi.service.documenso.gen.invoker.auth.Authentication;
...
public class ApiClient {
  ...
  private String basePath = "https://app.documenso.com/api/v2";
   ...
   * @return MediaType The Content-Type header to use. If the given array is empty, JSON will be
   *     used.
   */
