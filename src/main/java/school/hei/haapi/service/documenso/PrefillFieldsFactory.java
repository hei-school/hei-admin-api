...
import school.hei.haapi.model.TemplateFieldLabels;
...
public class PrefillFieldsFactory {
  ...
  private List<TemplateCreateDocumentFromTemplateRequestPrefillFieldsInner>
    ...
    matchOnly(textFields, TemplateFieldLabels.FULL_NAME, student.fullName())
        .ifPresent(prefillFields::add);
    matchOnly(textFields, TemplateFieldLabels.LEVEL, level == null ? null : getLevelString(level))
        .ifPresent(prefillFields::add);
    matchByPosition(textFields, TemplateFieldLabels.PARENT_INDICATOR, monitor.fullName(), true)
        .ifPresent(prefillFields::add);

    for (var label :
        List.of(TemplateFieldLabels.ADDRESS, TemplateFieldLabels.PHONE, TemplateFieldLabels.NIC)) {
  ...
  private List<TemplateCreateDocumentFromTemplateRequestPrefillFieldsInner> buildDefaultFields(
    ...
    matchOnly(textFields, TemplateFieldLabels.LEVEL, level == null ? null : getLevelString(level))
        .ifPresent(prefillFields::add);
    matchOnly(textFields, TemplateFieldLabels.NIC, student.nic()).ifPresent(prefillFields::add);
    matchOnly(textFields, TemplateFieldLabels.ADDRESS, student.address())
        .ifPresent(prefillFields::add);
    matchOnly(textFields, TemplateFieldLabels.PHONE, student.phone()).ifPresent(prefillFields::add);
    return prefillFields;
  }
