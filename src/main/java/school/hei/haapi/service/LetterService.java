...
import school.hei.haapi.endpoint.rest.model.UpdateLettersStatusResponse;
...
public class LetterService {
    ...
    public List<Letter> getLetters(String ref, String studentRef, PageFromOne page, BoundedPageSize pageSize) {
        Pageable pageable =
    ...
    public Letter getLetterById(String id) {
        return letterRepository.findById(id).orElseThrow(() -> new NotFoundException("Letter not found"));
    }

    public Letter createLetter(String studentId, String description, String filename,  MultipartFile file) {
        ...
        Letter letterToSave = Letter.builder()
                .id(uuid)
                .status(PENDING)
    ...
    public List<Letter> getLettersByStudentId(String studentId, PageFromOne page, BoundedPageSize pageSize) {
        Pageable pageable =
                PageRequest.of(page.getValue() - 1, pageSize.getValue(), Sort.by(ASC, "creationDatetime"));
