...
public class PromotionService {
    ...
    public List<Promotion> getPromotions(String name, String ref, String groupRef, PageFromOne page, BoundedPageSize pageSize){
        Pageable pageable =
    ...
    public Promotion getPromotionById(String id){
        return promotionRepository.findById(id).orElseThrow(() -> new NotFoundException("Promotion with #id " + id + " not found"));
    }
