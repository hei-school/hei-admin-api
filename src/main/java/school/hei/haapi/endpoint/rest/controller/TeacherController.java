...
public class TeacherController {
  ...
  public Teacher updateTeacher(
      @PathVariable(name = "id") String teacherId, @RequestBody CreateTeacher toUpdate) {
  ...
  public List<Teacher> createOrUpdateTeachers(@RequestBody List<CreateTeacher> toWrite) {
    return userService
