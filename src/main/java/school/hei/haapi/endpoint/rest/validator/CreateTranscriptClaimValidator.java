...
public class CreateTranscriptClaimValidator implements Consumer<StudentTranscriptClaim> {
  @Override
  public void accept(StudentTranscriptClaim studentTranscriptClaim) {
    if (studentTranscriptClaim.getReason() == null
        && studentTranscriptClaim.getReason().isEmpty()) {
    ...
    if (studentTranscriptClaim.getTranscriptId() == null
        && studentTranscriptClaim.getTranscriptId().isEmpty()) {
      throw new BadRequestException("Transcript Id is mandatory");
    }
    if (studentTranscriptClaim.getTranscriptVersionId() == null
        && studentTranscriptClaim.getTranscriptVersionId().isEmpty()) {
    ...
    if (studentTranscriptClaim.getCreationDatetime() != null
        ...
        && studentTranscriptClaim
            .getClosedDatetime()
            .isBefore(studentTranscriptClaim.getCreationDatetime())) {
