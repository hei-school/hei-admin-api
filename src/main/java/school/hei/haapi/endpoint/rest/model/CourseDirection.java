...
public enum CourseDirection {
  ...
  @JsonCreator
  public static CourseDirection fromValue(String value) {
    for (CourseDirection b : CourseDirection.values()) {
