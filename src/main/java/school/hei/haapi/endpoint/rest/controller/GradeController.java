...
public class GradeController {
  ...
  public ExamDetail getExamGrades(@PathVariable("group_id") String groupId,
  ...
  public StudentGrade getGradeOfStudentInOneExam(@PathVariable("group_id") String groupId,
