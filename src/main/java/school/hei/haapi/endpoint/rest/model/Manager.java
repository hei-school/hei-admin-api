...
@JsonPropertyOrder({
  ...
  Manager.JSON_PROPERTY_REF,
  Manager.JSON_PROPERTY_FIRST_NAME,
  Manager.JSON_PROPERTY_LAST_NAME,
  Manager.JSON_PROPERTY_EMAIL,
  Manager.JSON_PROPERTY_SEX,
  Manager.JSON_PROPERTY_BIRTH_DATE,
  Manager.JSON_PROPERTY_ADDRESS,
  Manager.JSON_PROPERTY_PHONE,
  Manager.JSON_PROPERTY_ENTRANCE_DATETIME,
...
public class Manager {
  ...
  public Manager birthDate(java.time.LocalDate birthDate) {
  ...
  public Manager entranceDatetime(java.time.Instant entranceDatetime) {
