...
public class TranscriptClaimController {
  ...
  public List<StudentTranscriptClaim> getClaims(
    ...
    return transcriptClaimService
        .getAllByVersionId(studentId, transcriptId, versionId, page, pageSize)
        .stream()
  ...
  @GetMapping(
      "/students/{student_id}/transcripts/{transcript_id}/versions/{version_id}/claims/{claim_id}")
  public StudentTranscriptClaim getClaimsById(
    ...
    return transcriptClaimMapper.toRest(
        transcriptClaimService.findByVersionIdAndClaimId(
  ...
  public StudentTranscriptClaim CreateOrUpdateTranscriptVersionClaim(
    ...
    return transcriptClaimMapper.toRest(
        transcriptClaimService.save(
            transcriptClaimMapper.toDomain(
                studentTranscriptClaim, studentId, transcriptId, versionId, claimId),
            studentId,
            transcriptId,
            versionId,
            claimId));
