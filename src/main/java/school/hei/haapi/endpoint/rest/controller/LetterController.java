...
public class LetterController {
    ...
    public List<Letter> getLetters(
      ...
      return letterService.getLetters(ref, studentRef, page, pageSize).stream().map(letterMapper::toRest).toList();
    }
    ...
    public List<Letter> getStudentLetters(
            ...
            @RequestParam(name = "page") PageFromOne page,
            @RequestParam(name = "page_size") BoundedPageSize pageSize) {
        return letterService.getLettersByStudentId(studentId, page, pageSize).stream().map(letterMapper::toRest).toList();
    }
