...
public class SecurityConf extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http
        ...
        .antMatchers(GET, "/students/*/transcripts/*").hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
            .antMatchers(PUT, "/students/*/transcripts").hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        ...
        .requestMatchers(new SelfMatcher(GET, "/students/*/transcripts/*/versions/*/claims")).hasAnyRole(STUDENT.getRole())
        .requestMatchers(new SelfMatcher(GET, "/students/*/transcripts/*/versions/*/claims/*")).hasAnyRole(STUDENT.getRole())
        ...
        .antMatchers(GET, "/students/*/transcripts/*/versions/*/claims/*").hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
            .antMatchers(PUT, "/students/*/transcripts/*/versions/*/claims/*").hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .antMatchers("/**").denyAll()
