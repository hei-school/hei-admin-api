...
public class SecurityConf extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http
        ...
        .antMatchers(GET, "/students/pointing").hasAnyRole(MANAGER.getRole())
        .antMatchers(GET, "/students/pointing").hasAnyRole(TEACHER.getRole())
        .requestMatchers(new SelfMatcher(GET, "/students/pointing")).hasAnyRole(STUDENT.getRole())
        .requestMatchers(new SelfMatcher(POST, "/students/*/pointing")).hasAnyRole(STUDENT.getRole())
        .antMatchers(POST, "/students/*/pointing").hasAnyRole(MANAGER.getRole())
        .antMatchers(GET, "/courses/calendar").authenticated()
        .antMatchers(PUT, "/courses/calendar").hasAnyRole(MANAGER.getRole())
