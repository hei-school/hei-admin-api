...
public class SecurityConf extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http
        ...
        .antMatchers(GET, "/courses/*/exams/**").hasAnyRole(STUDENT.getRole())
        ...
        .antMatchers(GET, "/courses/**").authenticated()
        .antMatchers(GET, "/courses/*/exams/**").hasAnyRole(MANAGER.getRole())
        ...
        .antMatchers(GET, "/courses").authenticated()
        .antMatchers(GET, "/courses/*/exams/**").hasAnyRole(TEACHER.getRole())
