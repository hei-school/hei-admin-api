...
public class SecurityConf extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http
        ...
        .antMatchers(GET, "/courses/*/pointing").hasAnyRole(MANAGER.getRole())
        .antMatchers(GET, "/courses/*/pointing").hasAnyRole(TEACHER.getRole())
        .requestMatchers(new SelfMatcher(GET, "/courses/*/pointing")).hasAnyRole(STUDENT.getRole())
