...
public class SecurityConf extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.exceptionHandling()
        ...
        .requestMatchers(
            new SelfMatcher(PUT, "/students/*/transcripts/*/versions/*/claims/*", "students"))
        .hasAnyRole(STUDENT.getRole())
        ...
        .antMatchers(GET, "/groups/*/awarded_courses/*/exams/*")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .antMatchers(GET, "/groups/*/awarded_courses/*/exams/*/grades")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .requestMatchers(
            new SelfMatcher(
                GET, "/groups/*/awarded_courses/*/exams/*/students/*/grade", "students"))
        .hasAnyRole(STUDENT.getRole())
        .antMatchers(GET, "/groups/*/awarded_courses/*/exams/*/students/*/grade")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        ...
        .antMatchers(GET, "/groups/*/awarded_courses/*/exams/*/students/*/grade")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .antMatchers(GET, "/groups/*/students")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .antMatchers(GET, "/groups/**")
        .hasAnyRole(MANAGER.getRole())
        .antMatchers(PUT, "/groups/**")
        .hasAnyRole(MANAGER.getRole())
        .antMatchers(GET, "/courses")
        .authenticated()
        .antMatchers(PUT, "/courses")
        .hasAnyRole(MANAGER.getRole())
        .antMatchers(PUT, "/courses/**")
        .hasAnyRole(MANAGER.getRole())
        .antMatchers(GET, "/courses/*")
        ...
        .antMatchers(GET, "/courses/*/exams/*")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .antMatchers(GET, "/courses/*/exams/*/details")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .requestMatchers(new SelfMatcher(GET, "/courses/*/exams/*/participants/*", "participants"))
        .hasAnyRole(STUDENT.getRole())
        ...
        .requestMatchers(new SelfMatcher(GET, STUDENT_COURSE, "students"))
        .hasAnyRole(STUDENT.getRole())
        .antMatchers(GET, STUDENT_COURSE)
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .antMatchers(PUT, STUDENT_COURSE)
        .hasAnyRole(MANAGER.getRole())
        .requestMatchers(new SelfMatcher(GET, "/students/*/transcripts", "students"))
        .hasAnyRole(STUDENT.getRole())
        .requestMatchers(new SelfMatcher(GET, "/students/*/transcripts/*", "students"))
        .hasAnyRole(STUDENT.getRole())
        .antMatchers(GET, "/students/*/transcripts")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .antMatchers(GET, "/students/*/transcripts/*")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .antMatchers(PUT, "/students/*/transcripts")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .requestMatchers(new SelfMatcher(GET, "/students/*/transcripts/*/versions", "students"))
        .hasAnyRole(STUDENT.getRole())
        .requestMatchers(new SelfMatcher(GET, "/students/*/transcripts/*/versions/*", "students"))
        .hasAnyRole(STUDENT.getRole())
        .requestMatchers(
            new SelfMatcher(GET, "/students/*/transcripts/*/versions/*/raw", "students"))
        .hasAnyRole(STUDENT.getRole())
        .requestMatchers(
            new SelfMatcher(GET, "/students/*/transcripts/*/versions/*/claims", "students"))
        .hasAnyRole(STUDENT.getRole())
        .requestMatchers(
            new SelfMatcher(GET, "/students/*/transcripts/*/versions/*/claims/*", "students"))
        .hasAnyRole(STUDENT.getRole())
        .antMatchers(GET, "/students/*/transcripts/*/versions")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .antMatchers(GET, "/students/*/transcripts/*/versions/*")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .antMatchers(GET, "/students/*/transcripts/*/versions/*/raw")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .antMatchers(POST, "/students/*/transcripts/*/versions/*/raw")
        .hasAnyRole(MANAGER.getRole())
        .antMatchers(GET, "/students/*/transcripts/*/versions/*/claims")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .antMatchers(GET, "/students/*/transcripts/*/versions/*/claims/*")
        .hasAnyRole(TEACHER.getRole(), MANAGER.getRole())
        .antMatchers(PUT, "/students/*/transcripts/*/versions/*/claims/*")
        .hasAnyRole(MANAGER.getRole())
        .antMatchers("/**")
        .denyAll()
