...
public class AdvancedFeeStatsMapper {
  ...
  private AdvancedFeeStats getModelTotalFeeStats(
    ...
    return AdvancedFeeStats.builder()
        ...
        .firstGradeCountMonthly(restStat.getFirstGradeMonthly())
        .secondGradeCountMonthly(restStat.getSecondGradeMonthly())
        .thirdGradeCountMonthly(restStat.getThirdGradeMonthly())
        .firstGradeCountYearly(restStat.getFirstGradeYearly())
        .secondGradeCountYearly(restStat.getSecondGradeYearly())
        .thirdGradeCountYearly(restStat.getThirdGradeYearly())
        .unknownGradeCount(restStat.getUnknownGrade())
        .remedialFirstGradeCount(restStat.getRetakeExamFirstGradeCount())
        .remedialSecondGradeCount(restStat.getRetakeExamSecondGradeCount())
        .remedialThirdGradeCount(restStat.getRetakeExamThirdGradeCount())
  ...
  private LateFeesStats getRestLateFeeStats(AdvancedFeeStats modelStat) {
    return new LateFeesStats()
        ...
        .retakeExamFirstGradeCount(modelStat.getRemedialFirstGradeCount())
        .retakeExamSecondGradeCount(modelStat.getRemedialSecondGradeCount())
        .retakeExamThirdGradeCount(modelStat.getRemedialThirdGradeCount())
