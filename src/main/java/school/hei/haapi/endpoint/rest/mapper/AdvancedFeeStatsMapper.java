...
public class AdvancedFeeStatsMapper {
  ...
  private AdvancedFeeStats getModelTotalFeeStats(
    ...
    return AdvancedFeeStats.builder()
        ...
        .remedialFirstGradeCount(safe(restStat.getRetakeExamFirstGradeCount()))
        .remedialSecondGradeCount(safe(restStat.getRetakeExamSecondGradeCount()))
        .remedialThirdGradeCount(safe(restStat.getRetakeExamThirdGradeCount()))
