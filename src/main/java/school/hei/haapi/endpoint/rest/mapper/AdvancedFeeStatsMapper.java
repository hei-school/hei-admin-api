...
public class AdvancedFeeStatsMapper {
  ...
  private LateFeesStats getRestLateFeeStats(AdvancedFeeStats modelStat) {
    return new LateFeesStats()
        ...
        .retakeExamFirstGradeCount(modelStat.getFirstGradeCount())
        .retakeExamSecondGradeCount(modelStat.getSecondGradeCount())
        .retakeExamThirdGradeCount(modelStat.getThirdGradeCount())
