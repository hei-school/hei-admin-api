...
"""
  ...
  /** Requests the archiving of this fee: it stays unarchived until a validator reviews it. */
  public Fee requestArchive() {
  ...
  /** Validates a pending archive request: the fee becomes actually archived. */
  public Fee validateArchive() {
    requireToArchive();
  ...
  /** Rejects a pending archive request: the fee stays unarchived. */
