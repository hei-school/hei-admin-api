insert into "user"
(id,first_name, last_name, email, ref, status, sex, birth_date, entrance_datetime,
 phone, address,
 "role",group_id)
values ('student1_id','Ryan', 'Andria', 'test+ryan@hei.school', 'STD21001',
        'ENABLED', 'M',
        '2000-01-01',
        '2021-11-08T08:25:24.00Z', '0322411123', 'Adr 1', 'STUDENT','group1_id'),
       ('student2_id','Two', 'Student', 'test+student2@hei.school', 'STD21002',
        'ENABLED', 'F',
        '2000-01-02',
        '2021-11-09T08:26:24.00Z', '0322411124', 'Adr 2', 'STUDENT','group2_id'),
...
(id,first_name, last_name, email, ref, status, sex, birth_date, entrance_datetime,
 phone, address,
 "role")
values  ('teacher1_id','One', 'Teacher', 'test+teacher1@hei.school', 'TCR21001', 'ENABLED',
    'F',
        '1990-01-01',
